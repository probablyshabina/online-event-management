...
<body>
<%
AppointmentDBFuncs appDbFunc = new AppointmentDBFuncs();
...
<nav class="navbar navbar-expand-lg bg-light shadow-lg">
	...
	<div>
	<label class= "title">Appointment </label>
	</div>
		<div class="tableRow">
				<form action="anAppointmentServlet" method="GET" id="eventAppointmentsForm" name="eventAppointmentsForm">
				<div class="datadiv">
				<div class="Columns">
